...
Conducted digital forensic investigations on 3+ system images using Autopsy and FTK Imager to analyze system images and recover digital evidence.
	...
	•	Conducted cybersecurity risk assessments analyzing threats to confidentiality, integrity, and availability (CIA)
	•	Applied cryptographic methods to secure sensitive data and prevent unauthorized risk of data breaches. 
	•	Developed threat intelligence assessments using open source intelligence to anticipate  cyber threats.
