...
- Designed enterprise security archetecture frameworks to protect organizational networks, cloud system, and IoT environments from cyber threats. 
- Conducted cybersecuiryt risk assessments analyzing threats to confidentiality, integrity, and availability (CIA).
- Applied cryptographic methods to secure sensative data and prevent unauthorized risk of data breaches.
